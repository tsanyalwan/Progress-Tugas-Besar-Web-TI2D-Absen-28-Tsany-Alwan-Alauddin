			...
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="" method="POST" enctype="multipart/form-data">
					...
					<div class="contact100-form-checkbox">
						...
						<label class="label-checkbox100" for="ckb1">Remember</label>
					</div>

					<div class="container-login100-form-btn">
					<center><button type="submit" name="login" id="login" class="btn btn-primary">Login</button></div>
						<!-- <button class="login100-form-btn" name="login" type="submit">Login</button> -->
					</div>

					<div class="text-center p-t-90">
						<a class="txt1" href="#">Forgot Password?</a><br>
						<a class="txt1" href="../registrasi.html">Dont Have Account?</a>
					</div>
				</form>
			</div>
		</div>
